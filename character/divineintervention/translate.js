const translates = {
    ...
    dishenzhuri: "神主日",
    direnxing: "韧性",
    direnxing_info: "锁定技。出牌阶段开始时，若你没有护甲，获得10点护甲。失去最后一点护甲时，你翻面并弃置所有手牌，并令场上所有其他角色获得两点护甲。",
    diyuxiang: "余响",
    diyuxiang_info: "锁定技。第一次进入濒死状态时，你增加5点体力上限并回复全部体力，升级技能【回声】【异梦】。第二次进入濒死状态时，你增加10点体力上限并回复全部体力，失去技能【回声】【异梦】，获得技能【太初】【造物】。",
    dihuisheng: "回声",
    dihuisheng_info: "锁定技。游戏开始时，你在左右两侧各召唤两个『旧梦的回声』。『旧梦的回声』具有一点体力上限，没有初始手牌。『旧梦的回声』受到的伤害由你承受，当你因此受伤时，将对应的『旧梦的回声』翻面。摸牌阶段，你多摸X张牌（X为未翻面的『旧梦的回声』数量）。",
    dihuisheng2: "回声",
    dihuisheng2_info: "锁定技。游戏开始时，你在左右两侧各召唤两个『旧梦的回声』。『旧梦的回声』具有一点体力上限，没有初始手牌。『旧梦的回声』受到的伤害由你承受，当你因此受伤时，将对应的『旧梦的回声』翻面。摸牌阶段，你多摸X张牌（X为未翻面的『旧梦的回声』数量）。『旧梦的回声』在准备阶段可视为使用一张无距离限制的【杀】。",
    diyimeng: "异梦",
    diyimeng_info: "出牌阶段限一次，你可以弃置一张手牌并选择一名其他角色，直到你的下个出牌阶段开始，该角色受到的伤害+1。",
    diyimeng2: "异梦",
    diyimeng2_info: "出牌阶段限一次，你可用弃置任意张手牌并选择等量其他角色，直到你的下个出牌阶段开始，这些角色受到的伤害+1，手牌上限-1。",
    ditaichu: "太初",
    ditaichu_info: "锁定技。你跳过所有阶段。其他角色回合结束时你获得1层【日】。当【日】的数量达到7时，你对所有其他角色造成4点伤害，并弃置所有【日】。",
    dizaowu: "造物",
    dizaowu_info: "锁定技。你翻面后，弃置3层【日】。你受到伤害后，伤害来源摸一张牌。",
};
