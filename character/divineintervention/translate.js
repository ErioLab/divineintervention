const translates = {
    ...
    dizxj: "宗小静",
    dimoxie: "默写",
    dimoxie_info: "出牌阶段限四次，你可弃置一张牌选择任意名其他角色同时参加英语默写。最先回答正确的角色摸三张牌，回答错误或最后回答的角色获得一个【不及】。出牌阶段结束时，你弃置所有角色的【不及】，并根据每名角色弃置的数量：1.其弃置一张牌，2.其失去一点体力，3.其弃置三张牌，你失去一点体力，4.你与其均翻面。",
};
