const translates = {
    ...
    dipojun: "破军",
    dipojun2: "破军",
    dipojun_info: "当你使用【杀】指定一名角色为目标后，你可以依次执行：1.弃置1/2个【城】，将该角色的至多X张牌/全部牌置于其武将牌上（X为该角色的体力值），然后当前回合结束时，其获得武将牌上的牌；2.弃置2个【城】，使该【杀】伤害+Y+1（Y为你与其装备区牌数的差）。3.弃置2个【城】，使该【杀】不计入次数上限。",
};
