const translates = {
    ...
    difuxuan: "【前瞻】符玄",
    diqiongguan: "穷观",
    diqiongguan_info: "回合开始时，你可观察牌堆顶六张牌（场上存活人数少于四时改为四张），并将其中任意张以任意顺序置于你【穷观阵】中的【元】【亨】【利】【贞】区（其他角色可见）。锁定技：有角色摸牌时，其取消摸牌并改为从【元】中按顺序获得等量牌；有角色判定时，其取消从牌堆展示判定牌并改为从【亨】中按顺序移出一张牌作为不可改变的最终判定牌；回合结束时，你将【贞】中的牌按顺序置入牌堆底。",
    disanyan: "三眼",
    disanyan_info: "出牌阶段限一次，你可观察一名其他角色的手牌，并选择：弃置其手牌中至多两张与【利】花色相同的牌，或使其获得至多两张与其手牌花色不同的【利】。",
    dibie: "避厄",
    dibie_info: "每轮限一次，你的体力为一或濒死时，你可弃置【穷观阵】中所有牌，每以此法弃置一张红桃牌，视为对你自己使用一张【桃】。",
};
