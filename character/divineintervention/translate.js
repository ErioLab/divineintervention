const translates = {
    ...
    dizangsong: "葬送",
    dizangsong_info: "锁定技。你受到伤害或流失体力后，获得等量【赐】。任意角色的结束阶段，若你拥有至少4层【赐】，你弃置所有【赐】，回复一点体力并获得一个额外回合。",
    diwansi: "万死",
    ...
    dihongye: "红叶",
    dihongye_info: "结束阶段，你可以与一名其他角色进行拼点，且拼点牌点数+X（X为你拥有的【残梦】数量）。若你赢，你可移动其区域内一张牌，若你没赢，你受到该角色的一点雷属性伤害，并获得双方拼点牌。你的拼点牌点数+X（X为你拥有的【残梦】数量）。",
    diyuzhan: "雨斩",
    ...
    jie_diganyu: "界甘雨",
    dijie_shuanghua: "霜华",
    dijie_shuanghua_info: "①结束阶段，你可将任意张【杀】置于武将牌上称为【矢】。②出牌阶段开始前，若武将牌上存在【矢】，你可选择一名角色，视为对其及其上下家使用冰【杀】，随后弃置一张【矢】，你每以此法造成一点伤害便摸一张牌。③锁定技，当你受到伤害后，你弃置一张【矢】。④锁定技，若你的武将牌上存在【矢】，你视为装备【麒麟弓】。",
    dijie_linji: "麟迹",
    ...
    diyftx: "一方通行",
    dishiliang: "矢量",
    dishiliang_info: "当你成为其他角色使用牌的唯一目标后，你可将手牌补至四张并弃置其中任意张，若弃置的牌的点数经加减乘除括号运算后值为24，你令此牌对你无效，且你可以失去一点体力上限视为反向处理对你使用的牌。",
    //浊心斯卡蒂
    dizxskd_prefix: "浊心",
    dizxskd: "浊心斯卡蒂",
    dixueqin: "血亲",
    ...
    dizxj: "宗小静",
    dimoxie: "默写",
    dimoxie_info: "出牌阶段限一次，你可弃置一张牌选择任意名其他角色同时参加英语默写。最先回答正确的角色摸两张牌，回答错误的角色获得一个【不及】。出牌阶段结束时，你可弃置所有角色的【不及】，并根据每名角色弃置的数量：1.其弃置两张牌，2.其失去一点体力，3.其翻面，4.其死亡。",
    //符玄
    difuxuan: "符玄",
    diqiongguan: "穷观",
    ...
    diliujian: "留剑",
    diliujian_info: "限定技，当你进入濒死状态时，你可依次使用【剑】中的【杀】和伤害性锦囊牌，且无距离和次数限制。",
    //谋徐盛
    dimou_xusheng: "谋徐盛",
    ...
    dihutao: "胡桃",
    diwangsheng: "往生",
    diwangsheng_info: "有角色死亡时，你可减少一点体力上限，视为死亡角色的击杀者。",
    dihumo: "护摩",
    dihumo_info: "锁定技，你的体力小于体力上限的一半时，造成的伤害+1。",
    didieying: "蝶引",
    didieying_info: "出牌阶段限一次，你可以流失一点体力或减少一点体力上限，选择四项中的两项按选择顺序执行：1. 视为对相邻的三名角色使用火【杀】（无距离限制）；2.视为对至多X名角色使用【决斗】（X为你的体力值）；3. 失去一点体力；4. 恢复一点体力。",
    //异客
    diyike: "神异客",
    diyike_prefix: "神",
    ditianlei: "天雷",
    ditianlei_info: "锁定技，当你的判定区没有牌时，你的所有锦囊牌均视为【闪电】。你可对任意角色使用【闪电】。受到雷属性伤害时，你可弃置与伤害数值等量的手牌转移伤害。",
    dishenqi: "神祇",
    ...
    dishan: "闪",
    dishan_info: "每局游戏限三次，受到有来源伤害时，你可取消此伤害并进行一次判定，如果是梅花，视为你对伤害来源造成等量同属性伤害。",
    dizhan: "斩",
    dizhan_info: "限定技，出牌阶段，如果你本局游戏累计造成的伤害达到10点，你可视为使用五张不计入次数上限的【杀】。",
    //青雀
    diqingque: "青雀",
    diqiongyu: "琼玉",
    diqiongyu_info:"出牌阶段限四次，你可将一张手牌置于牌堆顶并从牌堆底摸一张牌，然后展示牌堆顶四张牌，若花色均不相同，你使用的下一张基本牌基数+1且可额外指定一名目标。（无任何限制）",
};
