const translates = {
    ...
    dishenzhuri: "神主日",
    direnxing: "韧性",
    direnxing_info: "锁定技。回合开始时，若你没有护甲，你获得X+5点护甲（X为场上敌对角色数量）。失去最后一点护甲时，你翻面并弃置所有手牌，并令场上所有敌对角色获得两点护甲。翻面后，若你的武将牌正面向上，你摸4张牌。",
    diyuxiang: "余响",
    ...
    diyimeng2: "异梦",
    diyimeng2_info: "出牌阶段限一次，你可以弃置任意张手牌并选择等量其他角色，直到你的下个出牌阶段开始，这些角色受到的伤害+1，手牌上限-1。",
    ditaichu: "太初",
    ditaichu_info: "锁定技。你跳过所有阶段。其他角色回合结束时你获得1层【日】。【日】的数量达到7后，下一次其他角色回合结束时，你对所有其他角色造成4点伤害，并弃置所有【日】。",
    dizaowu: "造物",
