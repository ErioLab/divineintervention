	...
	nodeintro(node, simple, evt) {
		...
		if (typeof node._customintro == "function") {
			...
			if (!game.observe && _status.gameStarted && game.me && node != game.me) {
					...
					if (game.online) {
						if (emotion == "flowers") {
							for (var c = 1; c <= 10; c++) {
								setTimeout(
									function () {
										game.send("throwEmotion", node, "flower");
									}, 100 * c);
							}
						} else if (emotion == "eggs") {
							for (var c = 1; c <= 10; c++) {
								setTimeout(
									function () {
										game.send("throwEmotion", node, "egg");
									}, 100 * c);
							}
						}
						...
						if (emotion == "flowers") {
							for (var c = 1; c <= 10; c++) {
								setTimeout(
									function () {
										game.me.throwEmotion(node, "flower");
									}, 100 * c);
							}
						} else if (emotion == "eggs") {
							for (var c = 1; c <= 10; c++) {
				...
				var listi = ["flower", "flowers", "egg", "eggs"];
				...
				table.style.width = "100%";
				table.style.position = "relative";
				var listi = ["wine", "shoe", "xianbei", "dingzhen", "weixian", "keli", "huiyingde", "laoda"];
