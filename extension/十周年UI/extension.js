			...
			window.dui = window.decadeUI = {
				...
				initOverride: function () {
					...
					lib.element.Card = class extends lib.element.Card {
						...
						$init() {
							...
							if (decadeUI.config.cardPrettify) {
								...
								let decadeCardSource = `${decadeUIPath}image/card/${fileName}.webp`//decadeExtCardImage[fileName];
								if (!decadeCardSource && cardName != fileName) decadeCardSource = `${decadeUIPath}image/card/${cardName}.webp`// decadeExtCardImage[cardName];
					...
					ui.create.identityCard = function (identity) {
						...
						const decadeExtCardImage = lib.decade_extCardImage || (lib.decade_extCardImage = {});
						const decadeCardSource = `${decadeUIPath}image/card/identity_${identity}.webp`//decadeExtCardImage[`identity_${identity}`];
